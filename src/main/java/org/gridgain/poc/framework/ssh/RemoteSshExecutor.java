...
public class RemoteSshExecutor extends AbstractCmdExecutor {
    /** */
     ...
     * @param args
     */
    public RemoteSshExecutor(PocTesterArguments args) {
        super(args);
    }
    ...
    public CmdResult runLocCmd(String cmd) throws IOException {
        ...
        return new CmdResult(exitCode, outStr, errStr, proc);
    }
